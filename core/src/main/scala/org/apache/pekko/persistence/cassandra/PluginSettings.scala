 ...
 * INTERNAL API
 */
@InternalApi private[pekko] class PluginSettings(system: ActorSystem, config: Config) {
 ...
 */
@InternalStableApi
@InternalApi private[pekko] object PluginSettings {

  val DefaultConfigPath = "pekko.persistence.cassandra"
